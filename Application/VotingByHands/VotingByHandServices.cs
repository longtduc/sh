...
namespace Application.VotingByHands
{
    public class VotingByHandServices
    {
        ...
        {
            var results = _context.VotingByHands.Include("VotingByHandLines").ToList();
            return results;
        }
        ...
        public VotingByHandResultView CreateVotingByHandResult()
        {
            var votingByHands = _context.VotingByHands.Include("VotingByHandLines")
                            .ToList();
            var result = new VotingByHandResultView(votingByHands);
            return result;
        }
