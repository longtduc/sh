...
{
    [TestClass]
    public class VotingResultVM_Test
    {
        ...
        {
            var sut = new VotingResultVM(_candidates, VotingCardType.BODVotingCard);
        ...
        {
            var sut = new VotingResultVM(_candidates, VotingCardType.BOSVotingCard);
        ...
        public void AccumulateForRoot_IfAccumulateIsPRIVATE_METHOD()
        {
            ...
            PrivateObject sut = new PrivateObject(typeof(VotingResultVM), types, values);
